...
def build():
    ...
    # 2027 keeper cost. The test is whether the player has an auction/keeper price on the
    # sheet: if not (never bought at auction), it's a flat $5 to keep next year. Otherwise the
    # price-grows-by-1 escalation (2*2026 - 2025 + 1), or a freshly-auctioned player's first
    # keep (2026 + 2). This ignores ESPN's acquisition tag on purpose — a player keeps his
    # auction price even if he was later dropped and re-added.
    for r in records:
