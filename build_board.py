...
def build():
    ...
    # The test is whether the player has an auction/keeper price on the sheet: if not (never
    # bought at auction), it's a flat $5 to keep next year. Otherwise the price-grows-by-1
    ...
    data = {"league": LEAGUE, "season": SEASON, "buyin": BUYIN, "live": live,
            "stale": stale, "snapshot_at": snapshot_at,
